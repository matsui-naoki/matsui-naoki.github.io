...
export default function PublicationsPage() {  const publications = [
    // 2025年
    {
      year: '2025',
          ...
          >
            ...
            <div className="mt-4 text-center">
              <div className="inline-flex items-center space-x-4 bg-gray-800/50 rounded-lg px-6 py-3 border border-cyan-400/20">
                ...
                <span className="text-blue-400 font-mono text-sm">解説記事: {reviews.length}報</span>
                <span className="text-gray-400">|</span>
                <span className="text-green-400 font-mono text-sm">特許: 8件</span>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-black rounded-2xl p-8 border border-gray-800">
              ...
              <div className="grid md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">解説記事</div>
                </div>
                <div>
