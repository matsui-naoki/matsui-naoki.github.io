...
export default function TechLayout() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Profile Section */}
      <section id="profile" className="py-20 bg-gradient-to-br from-gray-900 to-black">
              ...
              <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-white text-sm font-medium">matsui.n.ee49[at]m.isct.ac.jp</div>
                  </div>
                  <div>
                    <div className="font-mono text-xs text-cyan-400 mb-1">LOCATION</div>
                    <div className="text-white text-sm font-medium">東京科学大学 すずかけ台キャンパス G1-914</div>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`px-2 py-1 text-xs font-mono rounded ${
                    news.category === 'RESEARCH' ? 'bg-cyan-400/10 text-cyan-400 border border-cyan-400/20' :
                    news.category === 'CONFERENCE' ? 'bg-purple-400/10 text-purple-400 border border-purple-400/20' :
                    news.category === 'SEMINAR' ? 'bg-blue-400/10 text-blue-400 border border-blue-400/20' :
                    news.category === 'EXPERIMENT' ? 'bg-green-400/10 text-green-400 border border-green-400/20' :
                    news.category === 'VISIT' ? 'bg-orange-400/10 text-orange-400 border border-orange-400/20' :
